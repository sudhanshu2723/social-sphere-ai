...
// current->tells the current plan of the user
// label->tells it is of which card (PRO card) or (FREE Card)
// landing->we are landing from the landing page or not
export default function PaymentCard({current,label,landing}:Props){
    return (
        <div
      className={cn(
        label !== current
